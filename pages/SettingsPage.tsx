...
import { MapPin, Phone, Mail, Trash2, UploadCloud, XCircle, Download, Upload, RefreshCw } from 'lucide-react';
                    ...
                    <div className="border-t pt-6">
                        ...
                        <div className="border-b border-gray-200">
                            <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                                <button type="button" onClick={() => setActiveTab('invoiceTerms')} className={`${activeTab === 'invoiceTerms' ? 'border-brand-blue text-brand-blue' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}>
                                    Invoice Terms
                                </button>
                                <button type="button" onClick={() => setActiveTab('quoteTerms')} className={`${activeTab === 'quoteTerms' ? 'border-brand-blue text-brand-blue' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}>
                                    Quote Terms
                                </button>
                                <button type="button" onClick={() => setActiveTab('purchaseOrderTerms')} className={`${activeTab === 'purchaseOrderTerms' ? 'border-brand-blue text-brand-blue' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm`}>
             ...
             <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <div className="space-y-4">
                    <div className="p-4 border rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 mt-1">Download a full backup of all your application data as a JSON file.</p>
                        <button onClick={handleExport} className="mt-3 text-sm font-medium text-blue-600 hover:text-blue-800">Export All Data</button>
                    </div>
                     <div className="p-4 border rounded-lg">
                        <div className="flex items-center">
                        ...
                        <label htmlFor="import-file-input" className="cursor-pointer mt-3 inline-block text-sm font-medium text-green-600 hover:text-green-800">
                           Import from Backup File
                        </label>
                    </div>
                     <div className="p-4 border border-red-300 bg-red-50 rounded-lg">
                        <div className="flex items-center">
                            <RefreshCw className="h-5 w-5 mr-3 text-red-600"/>
                            <h3 className="font-semibold text-red-800">Reset Application</h3>
                        </div>
                        <p className="text-sm text-red-700 mt-1">Permanently delete all data and reset the application to its initial state.</p>
                        <button onClick={handleReset} className="mt-3 text-sm font-medium text-red-600 hover:text-red-800">Reset All Data</button>
                    </div>
                </div>
            </div>
        </div>
