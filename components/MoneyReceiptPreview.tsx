                        ...
                        <div className="printable-header" dangerouslySetInnerHTML={{ __html: settings.headerSVG }} />
                         ...
                         <div className="pb-8">
                            ...
                            <section className="mt-10 text-center border-2 border-green-500 bg-green-50 py-6 px-4 rounded-lg">
                                ...
                                <p className="text-5xl font-bold tracking-tight text-green-600">{formatCurrency(payment.amount)}</p>
                            </section>
                            ...
                            <section className="mt-8 flex justify-end">
                                <div className="w-full max-w-xs space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between py-2 bg-gray-100 px-2 rounded font-bold">
                                        ...
                                        <span className="text-red-600">{formatCurrency(balanceDueAfterThisPayment)}</span>
                                    </div>
                                </div>
                            </section>
