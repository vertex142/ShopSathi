            ...
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col printable-document">
                <header className="flex justify-between items-center p-4 border-b bg-gray-50 rounded-t-lg non-printable">
                    ...
                    <div className="flex items-center space-x-2">
                        <button onClick={() => printDocument(printableId, `po-${purchaseOrder.poNumber}.pdf`)} className="flex items-center bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                    ...
                    <div className="bg-white shadow-lg p-10 relative printable-page" id={printableId}>
                        ...
                        <div className="pb-8">
                            ...
                            <section className="grid grid-cols-2 gap-8 mb-10">
                                ...
                                <div className="text-right">
                                 ...
                                 <div className="col-span-2">
                                    ...
                                    <p className="text-lg font-bold text-gray-800">Your Company</p>
                                    <p className="text-sm text-gray-600">Your Company Address from SVG</p>
                                </div>
                            </section>
                            ...
                            <footer className="mt-16 pt-8 border-t text-sm text-gray-600">
                                ...
                                <p className="text-xs mt-4 mb-24">Please ship all items to the address listed above. If you have any questions, please contact us.</p>
